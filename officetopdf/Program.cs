...
namespace officetopdf
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    Console.WriteLine("DOC转换成功！");
            //}
            //else
            //{
            //    Console.WriteLine("对不起，转换失败！");
            //}

            //if (XLSConvertToPDF(@"C:/东亚信托-AMPES职责梳理工具（12 投资管理部）V3.xlsx", "C:/testX.pdf"))
            //{
            //    Console.WriteLine("XLS转换成功！");
            //}
            //else
            //{
            //    Console.WriteLine("对不起，转换失败！");
            ...
            workbook.LoadFromFile(@"C:/东亚信托-AMPES职责梳理工具（12 投资管理部）V3.xlsx");
            ...
            pdfDocument.SaveToFile(@"C:/sample.pdf");
